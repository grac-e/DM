document.addEventListener("alpine:init", () => {
    Alpine.data("AutomatedDigitalMaturity", () => {
        return {
            ...
            business_manager_home_page:true,

            view_maturity_results:false,
            view_model_classification_results_predictions:false,
            ...
            openHome(currentSection) {
                ...
                this.business_manager_home_page=true;
                this.view_maturity_results=false;
                this.view_model_classification_results_predictions=false;
            ...
            }else if (currentSection == "view_maturity_results") {
                this.Admin_Home_Page = false;
                this.business_analysts_home_page=false;
                this.view_maturity_results = true;
                this.view_model_classification_results=false;
            }else if (currentSection == "view_model_classification_results_predictions") {
                this.Admin_Home_Page = false;
                this.business_analysts_home_page=false;
                this.view_model_classification_results_predictions=true;
                this.view_maturity_results=false;
